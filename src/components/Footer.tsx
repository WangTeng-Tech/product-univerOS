      ...
      <div className="container" style={{
        ...
        <div style={{ flex: '1 1 300px' }}>
          ...
          <div style={{ display: 'flex', gap: '0.875rem', marginTop: '1.5rem', alignItems: 'center' }}>
            ...
            <a href="https://bsky.app" target="_blank" rel="noopener noreferrer" className="social-icon" title="Bluesky">
              <svg width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                <path d="M3.468 1.948C5.303 3.325 7.276 6.118 8 7.616c.725-1.498 2.698-4.29 4.532-5.668C13.855.955 16 .186 16 2.632c0 .489-.28 4.105-.444 4.692-.572 2.04-2.653 2.561-4.504 2.246 3.236.551 4.06 2.375 2.281 4.2-3.376 3.464-4.852-.87-5.23-1.98-.07-.204-.103-.3-.103-.218 0-.081-.033.014-.102.218-.379 1.11-1.855 5.444-5.231 1.98-1.778-1.825-.955-3.65 2.28-4.2-1.85.315-3.932-.205-4.503-2.246C.28 6.737 0 3.12 0 2.632 0 .186 2.145.955 3.468 1.948"/>
              </svg>
            </a>
            <a href="https://joinmastodon.org" target="_blank" rel="noopener noreferrer" className="social-icon" title="Mastodon">
              <svg width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
          ...
          <span style={{ display: 'block', marginTop: '2rem', fontSize: '0.75rem', color: 'var(--color-text-muted)' }}>
            {t("footer.copyright")}
          </span>
        </div>
        
        {/* Link Columns */}
        <div className="footer-nav" style={{ display: 'flex', gap: '5rem', flexWrap: 'wrap' }}>
          <div>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              ...
              <li><a href="https://github.com" target="_blank" rel="noopener noreferrer">{t("footer.github")}</a></li>
            </ul>
          </div>
          <div>
            <h4 style={{ fontSize: '0.8rem', color: 'var(--color-text-primary)', marginBottom: '1.25rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Connect</h4>
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              <li><Link href="/console/login">{t("footer.sales")}</Link></li>
              <li><Link href="/partner">{t("footer.partner")}</Link></li>
            </ul>
          </div>
        </div>
      </div>

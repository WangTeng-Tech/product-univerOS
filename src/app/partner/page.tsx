...
const localTranslations = {
  zh: {
    ...
    subtitle: "共享全域 AI Workforce 自动化与全网认知感知市场红利",
    desc: "面向 IT 服务商、代运营机构与咨询团队，提供 120 站点代运营、企业安全审批门私有化落地与全域情报系统整装交付方案，享受 40% 首次订阅 + 25% 持续长尾分成。",
    ...
    benefit2Title: "Reality Ledger 账本公开对账",
    ...
    benefit4Title: "售前技术支持与全套方案物料",
    benefit4Desc: "提供完备的 PPT 方案白皮书、Demo 实机演练账号及资深架构师远程协助成单，安全合规。",
  ...
  en: {
    ...
    subtitle: "Share the Dividends of AI Workforce & Omni-Perception Market",
    desc: "Partner with us to accelerate enterprise AI adoption. Delivering 120-site operations, Dual-Rail security gates, and turnkey intelligence intake solutions with 40% initial + 25% recurring revenue share.",
    ...
    tier2Focus: "Regional Sales & Standard Reselling (POPULAR)",
    ...
    benefit1Desc: "Earn direct high returns: get 40% immediate revenue share on initial seat subscriptions, and 25% perpetual lifetime share on subsequent compute consumption.",
    benefit2Title: "Reality Ledger Open Book",
    benefit2Desc: "Referral logs are bound to billing order hash chains, ensuring immutable logs for transparent dispute-free monthly settlement.",
    ...
    benefit4Title: "Presales Architecture & Collateral Support",
    benefit4Desc: "Access complete whitepapers, live demo accounts, and senior solution architects to assist in closing deals.",
